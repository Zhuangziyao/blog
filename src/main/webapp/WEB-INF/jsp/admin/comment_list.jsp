                    ...
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered">
                            ...
                            <% List<Comment> comments=(List<Comment>)request.getAttribute("comments");
                                ...
                                <tr>
                                    <td style="display: none"><%=comments.get(i).getCoid()%></td>
                                    <td>
                                        <a href="../article/<%=comments.get(i).getCid()%>#comments"
                                           target="_blank"><%=comments.get(i).getContent()%></a>
                                    </td>
                                    <td><%=comments.get(i).getAuthor()%></td>
                                    <td><%=TimeTransform.TimStamp2Time(comments.get(i).getCreated())%></td>
                                    <td><%=comments.get(i).getMail()%></td>
                                    <td><a href="<%=comments.get(i).getUrl()%>" target="_blank">
                                        <%=comments.get(i).getUrl() %></a>
                                    </td>
                                    <td>
