                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="site_title" placeholder="站点名称"
                                                   value="<%=map.get("site_title")%>" required="required"
                                                   aria-required="true"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="site_description"
                                                   placeholder="站点描述"
                                                   value="<%=map.get("site_description")%>" required="required"
                                                   aria-required="true"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="site_record"
                                                   placeholder="ICP备案号"
                                                   value="<%=map.get("site_record")%>" required="required"
                                                   aria-required="true"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select name="site_theme" class="form-control">
                                                <option value="default" selected="<%=map.get("site_theme")%>">默认主题
                                                </option>
                                            </select>
                                        </div>
                                    </div>
