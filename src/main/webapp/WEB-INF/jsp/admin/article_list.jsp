                ...
                <div class="col-md-12">
                    <table class="table table-striped table-bordered">
                        ...
                        <% List<Article> articles=(List<Article>)request.getAttribute("articles");
                            ...
                            <tr>
                                <td style="display:none"><%=articles.get(i).getCid()%></td>
                                <td>
                                    <a href="./article/<%=articles.get(i).getCid()%>"><%=articles.get(i).getTitle()%></a>
                                </td>
                                <td><%=TimeTransform.TimStamp2Time(articles.get(i).getCreated())%></td>
                                <td><%=articles.get(i).getHits()%></td>
                                <td><%=articles.get(i).getCategories()%></td>
                                <td>
...
<div id="background" style="position:fixed;top: 0;left: 0;display: none;z-index:990;width: 100%;height: 100%;background-color: #0e2231;opacity: 0.5;"></div>
<div id="preview-box" class="post-content" style="position: fixed;z-index: 991;padding: 20px;display: none;margin-top:80px;top:0;left:25%;width: 50%;height: 80%;background-color: #f7f7f7;overflow: scroll;"></div>
