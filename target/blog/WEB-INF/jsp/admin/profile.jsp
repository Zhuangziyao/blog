                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" id="user-form">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="userName" type="text" value="<%=user.getUserName()%>" class="form-control"  readonly="readonly" disabled="disabled"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="screenName" type="text" class="form-control" name="screenName" placeholder="输入您的姓名"
                                                   value="<%=user.getScreenName()%>" required="required" aria-required="true"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="email" type="text" class="form-control" name="email" placeholder="输入您的邮箱"
                                                   value="<%=user.getEmail()%>" required="required" aria-required="true"/>
                                        </div>
                                    </div>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" id="pwd-form">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="oldPassword" type="password" class="form-control" name="oldPassword" required="required"
                                                   aria-required="true"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
