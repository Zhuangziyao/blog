...
<img  style="position: fixed;right: -20px;opacity: 0.5;width: 500px;" src="<%=path%>/static/user/img/hero/catwoman.png" alt="">
                ...
                <div class="post-list-item-container">
                    <a class="item-thumb bg-deepgrey" href="article/<%=articles.get(i).getCid() %>"
                       style="background:url('<%=path %>/static/user/img/rand/<%=articles.get(i).getCid()%>.jpg');
                        ...
                        <dir class="item-desc"><%=articles.get(i).getTags() %></dir>
                    </a>
                    ...
                    <div class="item-label">
                        ...
                        <div class="item-meta clearfix">
                            <div class="item-meta-ico <%=show_icon(articles.get(i).getCid())%> " style="background:url('<%=path%>/static/user/img/bg-ico.png');background-size:40px auto;"></div>
                            <div class="item-meta-cat">
                                <a href="./category/<%=articles.get(i).getCategories()%>"><%=articles.get(i).getCategories() %></a>
                            </div>
                        </div>
                    </div>
                </div>
